...
As measured on September 23, 2026, the 127 web tests (across 14 test files) cover 86.72% of statements, 86.50% of branches, 79.35% of functions, and 86.72% of lines. They exercise the single-flight WASM loader, the sorting lab's summary parsing and sonification planner (against a stub AudioContext), and representative Svelte application mount and interaction paths across the Fourier and sorting labs.
